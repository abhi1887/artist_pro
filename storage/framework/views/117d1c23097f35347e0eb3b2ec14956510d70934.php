...
unset($__errorArgs, $__bag); ?>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?php echo e(route('login')); ?>">Login Here</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('auth.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\artist_pro\resources\views/auth/register.blade.php ENDPATH**/ ?>